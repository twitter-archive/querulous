...
// FIXME TODO this was copied from Scala 2.9.1 due to the escaping functionality in 2.8.1 being poor.
// once Querulous drops support for 2.8 we can remove this.

package com.twitter.querulous.query.json

import scala.util.parsing.combinator._
import scala.util.parsing.combinator.syntactical._
import scala.util.parsing.combinator.lexical._
import util.parsing.json.Lexer
